            ...
            <div class="relative z-10 flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <Vueform ref="form$" :endpoint="submitForm" @success="handleSuccess" @error="handleError"
                        ...
                        <StaticElement name="h4" tag="h4" content="Actualizar contraseña SIP" />

                        <TextElement name="password" label="Contraseña" description="" />
                        ...
                        <ButtonElement name="submit" button-label="Actualizar" :submits="true" align="right" :columns="{
                            container: 6,
                        }" />
                    </Vueform>
                </div>
